...
public abstract class EarthquakeMarker extends CommonMarker
{
	...
	public void showTitle(PGraphics pg, float x, float y)
	{
		...
		String magnitude = this.getProperty("magnitude").toString();
		String radius = this.getProperty("radius").toString();
		
		/*
		 * pg.fill(250); pg.rect(x+10, y-12, 250, 16); //pg.strokeWeight(2); pg.fill(0);
		 * pg.textSize(10); pg.text("Magnitude: " +magnitude + ", Radius: " + radius,
		 * x+10, y );
		 */
		
		String ctTitle = "Magnitude: " + getMagnitude() + ", Radius: " + getRadius();
